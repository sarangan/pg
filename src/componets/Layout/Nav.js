  ...
  render() {
    ...
    return (
      ...
      <nav className="demo-navigation mdl-navigation mdl-color--blue-grey-800">
        ...
        <Link to="propertylist" className="mdl-navigation__link"><i className="mdl-color-text--blue-grey-400 material-icons" role="presentation">List</i>Property List</Link>
